...
/* Query definitions - removed per business entity pattern */
...
/* Removed per business entity pattern - data access through business entities only */
...
DO:
  ...
  VAR LOGICAL lIsValid               = FALSE.
  VAR LOGICAL lItemFound             = FALSE.
  
  /* Fetch existing item data */
  lItemFound = objItemEntity:GetItemByNumber(iItemNumber, OUTPUT DATASET dsItem).
  
  IF lItemFound AND AVAILABLE ttItem THEN DO:
    ...
    /* Validate data through entity */
    lIsValid = objItemEntity:ValidateItem(INPUT-OUTPUT DATASET dsItem, OUTPUT cErrorMessage).
    
    IF lIsValid THEN DO:
      /* Persist changes via entity method */
...
------------------------------------------------------------------------------*/
  ...
  /* Query opening removed - data access through business entities only */
